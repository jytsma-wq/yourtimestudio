    ...
    >
      {sections.map((section) => (
        <button
          ...
          className="relative group transition duration-150 ease-out"
        ...
        >
          ...
          {/* Tooltip */}
          <span
            className={`pointer-events-none absolute right-6 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-md border border-hairline bg-surface px-2.5 py-1 text-xs font-medium text-ink transition duration-150 ease-out ${
