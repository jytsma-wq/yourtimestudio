      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-8 pt-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="border border-border bg-card p-6 md:p-8">
            <p className="editorial-kicker text-teal">{t('description')}</p>
            ...
            <Link
              href="/insights"
              className="mt-8 inline-flex items-center gap-2 border-b border-foreground pb-1 text-sm font-semibold text-foreground hover:border-navy hover:text-navy"
            >
              {t('allArticles')}
            ...
            {articleMeta.map((article, index) => {
              ...
              return (
                ...
                >
                  ...
                  <ArrowRight className="size-4 text-muted-foreground transition-transform group-hover:translate-x-1 group-hover:text-navy" />
                </Link>
              );
            })}
          </div>
