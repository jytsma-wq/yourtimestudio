...
export async function HeroSection({ locale: _locale }: HeroSectionProps) {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-background px-4 pb-10 pt-12 sm:pt-14 md:px-8 lg:pb-12 lg:pt-12"
    >
        ...
        <div className="grid min-w-0 gap-10 lg:grid-cols-[minmax(0,1.04fr)_minmax(320px,0.96fr)] lg:gap-14 items-center">
          <div className="min-w-0">
            ...
            <div className="mt-8 grid max-w-[22rem] gap-3 sm:max-w-none sm:flex sm:flex-wrap">
              <Button
                asChild
                size="lg"
                className="h-12 w-full rounded-md px-6 text-base font-semibold sm:w-auto"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-12 w-full rounded-md border-foreground/25 bg-transparent px-6 text-base text-foreground hover:bg-muted sm:w-auto"
              >
                <Link href="/pricing">
                  {t('cta_secondary')}
                </Link>
          ...
          <div className="min-w-0">
            <div className="relative mx-auto w-full max-w-xl">
              <div className="relative aspect-[16/9] overflow-hidden border border-border bg-card shadow-none sm:aspect-[4/5]">
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-x-0 bottom-0 bg-ink/85 p-5 text-brand-cream">
              ...
              <div className="absolute -left-2 top-4 w-40 border border-border bg-background p-3 shadow-none sm:-left-4 sm:top-8 sm:w-44">
                <p className="editorial-kicker text-navy">{t('issue')}</p>
                <p className="mt-2 text-sm font-semibold leading-snug">
                  {t('cards.medical.tagline')}
                </p>
              </div>

              <div className="absolute -right-2 bottom-4 w-44 border border-border bg-background p-3 shadow-none sm:-right-4 sm:bottom-8 sm:w-52">
                ...
                <p className="editorial-kicker text-navy">{t('appointment_flow')}</p>
