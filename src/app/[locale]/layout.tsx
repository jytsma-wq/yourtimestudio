  ...
  return {
    ...
    icons: {
      icon: [
        ...
        { url: siteConfig.assets.favicon16, type: 'image/png', sizes: '16x16' },
        { url: siteConfig.assets.favicon32, type: 'image/png', sizes: '32x32' },
        { url: siteConfig.assets.favicon48, type: 'image/png', sizes: '48x48' },
        { url: siteConfig.assets.faviconPng, type: 'image/png', sizes: '512x512' },
      ],
      apple: [
